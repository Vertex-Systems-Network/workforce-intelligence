...
/** Provides installation guide catalog behavior within the WorkIntel application. */ final class InstallationGuideCatalog
{
    ...
    /** Handles the all operation for the current WorkIntel workflow. */
    public static function all(): array
    {
        return self::GUIDES;
    }

    /** Returns get data required by the current WorkIntel workflow. */
    public static function get(string $key): ?array
    {
        return self::GUIDES[$key] ?? null;
    }

    /** Handles the keys operation for the current WorkIntel workflow. */
