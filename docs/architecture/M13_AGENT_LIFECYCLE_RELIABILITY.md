...
Batches 1–6 are merged and certified on `main`: Batches 1–5 through PRs #17, #18, #20, #30 and #31 respectively, and Batch 6 through PR #37. Batch 6 passed exact-head Code Quality, CI/governance, and GitHub-hosted Windows certification on PR head `6eb2cfb3c69eda5692e6f0fec9020bd77ad4c075`, then merged to `main` as `43d15e2cd760ed519912227d9bfdc1778dd93cbb`; Issue #36 closed as completed. The published agent 1.2.2 and browser-extension 1.0.1 artifacts therefore remain the accepted immutable canonical release bytes, while runtime-bound deployment copies continue to be derived per request without mutating those published artifacts.
