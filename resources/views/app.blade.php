...
<head>
    ...
    <style>
        #workintel-boot-status{min-height:100vh;display:grid;place-items:center;padding:24px;background:#0c0c11;color:#a1a1b5;font:13px/1.6 Inter,system-ui,sans-serif;text-align:center}
