...
import { useConfirmAction, Alert, Badge, Button, Card, CardBody, CardHeader, DataGrid, Field, Input, Modal, Page, PageHeader, SearchInput, Switch, SettingRow, Tabs, Box, Grid, Inline, Stack, type DataGridColumn } from '../design-system';
type ModuleRow = {
    key: string;
    label: string;
    description: string;
