...
import { AppWindow, BookOpen, Check, CheckCircle2, Clipboard, Download as DownloadIcon, FileArchive, Globe2, Laptop, Monitor, RefreshCw, Terminal, Wrench } from 'lucide-react';
...
/** Handles the downloads operation for the WorkIntel client. */ export default function Downloads() {
    ...
    const serverUrl = center?.server_url ?? window.location.origin;
...
/** Handles the guide panel operation for the WorkIntel client. */ function GuidePanel({ guide, enrollment, status, busy, t, formatTime, onEnroll, onTest, onToggle, onCopy, command, onDownload, downloading, workspaceId, serverUrl }: {
    guide: Guide;
    enrollment: {
        enrollment_code: string;
        expires_at: string;
...
/** Handles the release section operation for the WorkIntel client. */ function ReleaseSection({ title, releases, onDownload, downloading, empty, formatDate, serverUrl }: {
    title: string;
    releases: Release[];
