...
import { useConfirmAction, Alert, Badge, Button, Card, CardBody, CardHeader, Field, Input, Select, Switch, Grid, Inline, Stack, Text, Form, Option, Box} from '../../design-system';
type Provider = {
    id: number;
    name: string;
...
/** Handles the screenshot storage settings operation for the WorkIntel client. */ export default function ScreenshotStorageSettings() {
    ...
    if (!data)
        return <Alert tone="info">Loading screenshot storage providers…</Alert>;
