...
export default function PublicWebsiteApp(){
 ...
 if(loading)return <div className="wi-public-site-state"><span className="wi-public-site-spinner"/>Loading website…</div>
 if(error||!payload)return <div className="wi-public-site-state"><strong>Website unavailable</strong><span>{error||'The requested page is not available.'}</span></div>
