...
agent_version='1.1.0'; browser_version='1.0.0'
...
rows=[row('agent-windows-x64','Windows 10/11','agent',w,agent_version,'Windows 10/11, Node.js 20+, PowerShell 5+','Per-user Scheduled Task installer.','windows-agent'),row('agent-macos','macOS','agent',m,agent_version,'macOS 12+, Node.js 20+','Per-user LaunchAgent installer.','macos-agent'),row('agent-linux','Linux','agent',l,agent_version,'Modern Linux desktop, Node.js 20+, systemd user session','systemd-user installer.','linux-agent'),row('browser-chrome-edge','Chrome / Microsoft Edge','extension',c,browser_version,'Chromium Manifest V3','Domain-only browser tracker package.','chrome-edge-extension'),row('browser-firefox','Mozilla Firefox','extension',f,browser_version,'Firefox 128+','Firefox Manifest V3 domain-only tracker package.','firefox-extension')]
